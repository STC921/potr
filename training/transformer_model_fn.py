...
if __name__ == '__main__':
  ...
  # parser.add_argument('--data_path', type=str, default='D:\\PycharmProjects\\potr\\data\\h36m_npy')
  # parser.add_argument('--learning_rate', type=float, default=1e-5)
  # parser.add_argument('--max_epochs', type=int, default=500)
  # parser.add_argument('--steps_per_epoch', type=int, default=200)
  # parser.add_argument('--action', nargs='*', type=str, default='all')
  ...
  parser.add_argument('--model_prefix', type=str, default='')  # Default will be overridden by command line input
  parser.add_argument('--batch_size', type=int, default=16)
  parser.add_argument('--data_path', type=str, default='D:\\PycharmProjects\\potr\\data\\h36m_npy')
  parser.add_argument('--learning_rate', type=float, default=0.0001)  # Change the default to 0.0001
  parser.add_argument('--max_epochs', type=int, default=500)
  parser.add_argument('--steps_per_epoch', type=int, default=200)
  parser.add_argument('--action', nargs='*', type=str, default='all')  # Ensure 'all' is used by default
  parser.add_argument('--use_one_hot', action='store_true')
  parser.add_argument('--init_fn', type=str, default='xavier_init')
  parser.add_argument('--include_last_obs', action='store_true')

  # Pose transformers related parameters
  parser.add_argument('--model_dim', type=int, default=128)  # Change the default to 128
  parser.add_argument('--num_encoder_layers', type=int, default=4)
  parser.add_argument('--num_decoder_layers', type=int, default=4)
  parser.add_argument('--num_heads', type=int, default=4)
  parser.add_argument('--dim_ffn', type=int, default=2048)
  ...
  parser.add_argument('--pre_normalization', action='store_true')
  parser.add_argument('--use_query_embedding', action='store_true')
  parser.add_argument('--predict_activity', action='store_true')  # This option is enabled
  parser.add_argument('--use_memory', action='store_true')
  parser.add_argument('--query_selection', action='store_true')
  parser.add_argument('--activity_weight', type=float, default=1.0)
  parser.add_argument('--pose_embedding_type', type=str, default='simple')  # Change to 'gcn_enc'
  parser.add_argument('--encoder_ckpt', type=str, default=None)
  parser.add_argument('--dataset', type=str, default='h36m_v2')  # This will be 'h36m_v2'
  parser.add_argument('--skip_rate', type=int, default=5)
  parser.add_argument('--eval_num_seeds', type=int, default=1)  # Set to default value
  parser.add_argument('--copy_method', type=str, default=None)
  parser.add_argument('--finetuning_ckpt', type=str, default=None)
  parser.add_argument('--pos_enc_alpha', type=float, default=10)
  parser.add_argument('--pos_enc_beta', type=float, default=500)
  ...
  print(train_dataset_fn.dataset._data_dim, train_dataset_fn.dataset._pose_dim)
